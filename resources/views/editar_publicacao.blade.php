        ...
        <div class="boxContent">
            <div class="tableContainer">
                <div class="tableBox">
                    ...
                    <form action="{{route('editarPub.update', $e->id)}}" method="post" enctype="multipart/form-data">
                    @else
                    <form action="{{route('editarPub.edit')}}" method="post" enctype="multipart/form-data">
                    @endif
                            <div class="boxPreview">
                                <div class="titlePreview">
                                    <h1 class="textEditar">Titulo da Publicação</h1>
                                    <input class="inputEditar" id="tituloDinamico" name="titulo" value="{{$e->titulo}}"></input>
                                </div>
                                ...
                                <div class="textoPreview">
                                    ...
                                    <textarea class="textAreaEditar" id="paragrafoDinamico" name="texto" class="paragraph" value="">{{$e->texto}}</textarea>
                                </div>
                                <div class="imgPreviewEdit">
                                    <h1 class="textEditar">Imagem da Publicação</h1>
                                    <input type="file" id="img_input" name="imagem" class="inputImageEdit" >
                                    <img id="img_preview" name="imagens" src="{{asset("img/{$e->imagem}") }}" alt="Image Preview" class="imgPreviewElement" />
                                </div>
